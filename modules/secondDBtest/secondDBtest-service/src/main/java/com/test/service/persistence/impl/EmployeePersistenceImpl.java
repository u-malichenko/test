...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public List<Employee> findByOccupation(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Employee employee : list) {
					if (!occupation.equals(employee.getOccupation())) {
						list = null;
	...
	public Employee findByOccupation_First(
		...
		Employee employee = fetchByOccupation_First(
	...
	public Employee fetchByOccupation_First(
		...
		List<Employee> list = findByOccupation(
	...
	public Employee findByOccupation_Last(
		...
		Employee employee = fetchByOccupation_Last(
			occupation, orderByComparator);
	...
	public Employee[] findByOccupation_PrevAndNext(
		...
		try {
			...
			array[0] = getByOccupation_PrevAndNext(
				session, employee, occupation, orderByComparator, true);

			array[1] = employee;

			array[2] = getByOccupation_PrevAndNext(
				session, employee, occupation, orderByComparator, false);
	...
	protected Employee getByOccupation_PrevAndNext(
		Session session, Employee employee, String occupation,
	...
	private static final String _FINDER_COLUMN_OCCUPATION_OCCUPATION_3 =
		"(employee.occupation IS NULL OR employee.occupation = '')";
