...
public interface EmployeePersistence extends BasePersistence<Employee> {
	 ...
	 */
	public java.util.List<Employee> findByOccupation(String occupation);
	 ...
	 */
	public java.util.List<Employee> findByOccupation(
	 ...
	 */
	public Employee findByOccupation_First(
			String occupation,
			com.liferay.portal.kernel.util.OrderByComparator<Employee>
				orderByComparator)
	 ...
	 */
	public Employee fetchByOccupation_First(
		String occupation,
		com.liferay.portal.kernel.util.OrderByComparator<Employee>
			orderByComparator);
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public Employee findByOccupation_Last(
			String occupation,
			com.liferay.portal.kernel.util.OrderByComparator<Employee>
				orderByComparator)
		throws NoSuchEmployeeException;
	 ...
	 */
	public Employee fetchByOccupation_Last(
		String occupation,
		com.liferay.portal.kernel.util.OrderByComparator<Employee>
			orderByComparator);
	 ...
	 */
	public Employee[] findByOccupation_PrevAndNext(
